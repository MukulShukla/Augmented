                 ...
                 Scalar & color)
{
    ...
    if(stddev[0] < max_deviation)
    {
	    ...
	    system("aplay /home/mukul/FinalYearProj/Augmented/Augmented/alarm.wav &");
        }
...
{
    const string DIR = "/home/mukul/FinalYearProj/Augmented/Augmented/MotionDetection/files/"; // directory where the images will be stored
    const string EXT = ".jpg"; // extension of the images
    const int DELAY = 500; // in mseconds, take a picture every 1/2 second
    const string LOGFILE = "/home/mukul/FinalYearProj/Augmented/Augmented/MotionDetection/files/";
	...
	int c = waitKey(10);
       if( c == 27 ) { break; }
        ...
        {
            /*
		Disabled, because saving was consuming time --> Can be debugged and enabled later
	...
	imshow( "SmartCam - Detecting Motioin... Press Esc to EXIT!", result );
    }
    return 0;    
}
